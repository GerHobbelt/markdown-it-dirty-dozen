/*! markdown-it-dirty-dozen 1.0.1-11 https://github.com//GerHobbelt/markdown-it-dirty-dozen @license MIT */
...
function use_dirty_dozen(md, options) {
  ...
  if (options) {
    ...
    usePlugin(anchor, options.anchor, defaultOptions.anchor); //usePlugin(highlighted, options.highlighted, defaultOptions.highlighted);
